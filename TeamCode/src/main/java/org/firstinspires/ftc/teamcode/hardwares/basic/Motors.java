...
public class Motors {
	...
	public void showPowers(){
		...
		try{client.changeData("LeftFrontPower(integration)",((IntegrationMotor)hardware.getDevice(HardwareDeviceTypes.LeftFront)).getPower());}catch (DeviceDisabledException ignored){}
